...
class StudentsPage(QWidget):
    ...
    def _setup_ui(self):
        ...
        header_view.setSectionResizeMode(1, QHeaderView.ResizeMode.Stretch) # Tên học viên giãn rộng nhất
        header_view.setSectionResizeMode(6, QHeaderView.ResizeMode.Fixed)
        self._table.setColumnWidth(6, 220) # Cột thao tác
    ...
    def _render_table(self, students: list):
        ...
        for row, s in enumerate(students):
            ...
            self._table.setRowHeight(row, 60) # Tăng độ cao hàng cho thoáng
            ...
            action_lay.setContentsMargins(10, 8, 10, 8)
